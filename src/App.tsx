...
const steps = [
  {
    target: "#name",
    content: "Đây là đầu vào để nhập tên.",
    placement: "bottom",
    disableBeacon: true,
  },
  {
    target: "#candle",
    content: "Thổi vào cổng Lightning để dập tắt nến.",
    placement: "bottom",
  },
  {
    target: "#start",
    content: "Nhấn bắt đầu để phát nhạc và thắp nến.",
    placement: "top",
  },
  {
    target: "#pause",
    content: "Nhấn tạm dừng nếu bạn muốn nhạc tạm dừng.",
    placement: "top",
  },
  {
    target: "#stop",
  ...
  },
  {
    ...
    content: "Nhấn nút nếu bạn muốn thắp sáng hoặc thổi tắt nến.",
    placement: "top",
  },
  {
    target: "#share",
    content: "Đổi tên và bấm 'Chia sẻ' để gửi quà cho mọi người.",
    placement: "top",
  },
